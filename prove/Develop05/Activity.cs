...
public class Activity
{
    ...
    static int _spinnerCount = 0;
    static int _userSessionLengthInput = 0;


    public Activity()
    {
        _spinnerCount = _userSessionLengthInput = 0;
    }
    ...
    {
        _startingMessage = $"Welcome to the {_activity}.";
    ...
    {
        _endingMessage = $"You have complete {_userSessionLengthInput} seconds of the {_activity}.";
